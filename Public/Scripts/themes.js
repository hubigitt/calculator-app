...
export function setTheme(currentTheme) {
	...
	const theme1 = () => {
		...
		themeSlider.className = "nav__theme__toggler__slider nav__theme__toggler__slider--theme1";
		...
		delButton.className = "keypad__button keypad__del-button keypad__del-button--theme1";
		resetButton.className = "keypad__button keypad__reset-button keypad__reset-button--theme1";
		equalsButton.className = "keypad__button keypad__equals-button keypad__equals-button--theme1";
	};
	const theme2 = () => {
		body.style.background = "hsl(0, 0%, 90%)";
		app.className = "app app--theme2";
		themeSlider.className = "nav__theme__toggler__slider nav__theme__toggler__slider--theme2";
		themeSliderDot.className =
		...
		delButton.className = "keypad__button keypad__del-button keypad__del-button--theme2";
		resetButton.className = "keypad__button keypad__reset-button keypad__reset-button--theme2";
		equalsButton.className = "keypad__button keypad__equals-button keypad__equals-button--theme2";
	};

	const theme3 = () => {
		body.style.background = "hsl(268, 75%, 9%)";
		app.className = "app app--theme3";
		themeSlider.className = "nav__theme__toggler__slider nav__theme__toggler__slider--theme3";
		themeSliderDot.className =
		...
		delButton.className = "keypad__button keypad__del-button keypad__del-button--theme3";
		resetButton.className = "keypad__button keypad__reset-button keypad__reset-button--theme3";
		equalsButton.className = "keypad__button keypad__equals-button keypad__equals-button--theme3";
	};
